...
If a figure is based on the attached paper, use it conceptually and redesign it as a clean slide-friendly diagram rather than copying the original figure exactly.Create only the central prompt-design figure for Slide 9.

Figure theme:
Structured text prompt design for controllable ophthalmic image generation.

Layout:
Top:
A formula-like prompt structure using four connected white boxes:

Modality + Disease + Lesion + Severity
...
Middle center:
A white outlined model block labeled:
EyeDiff
Use red for “EyeDiff”.
...
CFP should be color fundus-like.
OCT should be grayscale OCT-like.
FFA should be grayscale angiography-like.

Bottom:
A control diagram:
Change text → change modality / disease / lesion
