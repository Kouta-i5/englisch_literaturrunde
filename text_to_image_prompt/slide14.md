...
Create only the central table-style result figure for Slide 14.

Figure theme:
Representative improvements in minority classes and rare diseases.

Layout:
A clean table with four columns:
Target
Baseline
EyeDiff
Interpretation
...
Early glaucoma
Baseline: AUROC 0.860 / AUPR 0.570
EyeDiff: AUROC 0.927 / AUPR 0.809
Interpretation: Minority class improved

Stargardt disease
Baseline: AUROC 0.695 / AUPR 0.513
EyeDiff: AUROC 0.816 / AUPR 0.723
Interpretation: Rare disease improved

Retinoblastoma
Baseline: AUROC 0.740 / AUPR 0.316
EyeDiff: AUROC 0.787 / AUPR 0.742
Interpretation: Large AUPR improvement

Add a small side callout:
AUPR is important for minority positive cases

Style:
Pure white background.
White table cells.
Black and gray table grid.
Dark navy text.
Use red only to emphasize AUPR.
Use exact numbers only.
Make it spacious and readable.
No full slide title.
